...
const TemplateTwentyTwo: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
  ...
  {/* Header */}
  <header className="bg-sky-500 border-t border-b-8 border-sky-700 border-teal-600 py-6 px-5 mb-4 pointer-events-auto text-white text-center md:px-10 lg:px-16" 
  ...
  <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
   ...
   {/* <div className="w-16 h-16 flex items-center justify-center text-white font-bold text-xl overflow-hidden" 
    ...
    <div className="flex-1">
      ...
      <h1 className="text-3xl md:text-4xl font-bold uppercase tracking-wider text-teal-200 mb-2 ml-4">{doctor.clinicName}</h1>
  ...
  {/* Patient Info Grid */}
 <section className="grid grid-cols-3 bg-gray-200 gap-y-1 gap-x-3 text-sm-1 -my-3 border-b border-gray-200 pb-4 mb-8 pointer-events-auto">
  ...
  <div className="flex flex-col ml-4">
    ...
    <div className="flex items-center gap-0.5 mt-1">
      ...
      <div className="relative flex items-center">
        <PrintableInput 
          type="date"
          className="bg-gray-900 border-none outline-black-500  p-0 h-auto w-full pl-1 pr-6 hover:bg-gray-400"
          value={patient.date}
...
<div className="flex flex-col ml-4">
 ...
 <div className="flex flex-col">
  ...
  <div className="grid grid-cols-2 gap-4">
    ...
    <div>
      <div className="text-xs font-bold text-sky-900 uppercase mb-1">Chief Complaints</div>
      <div className="bg-sky-50 border border-gray-400 p-2 rounded-r">
        <PrintableTextarea 
          className="text-sm "
          minHeight="3rem"
  ...
  <div>
    <div className="text-xs-1   font-bold text-gray-500 mb-1">Past History:</div>
    <div className="bg-sky-100 border border-sky-700 rounded p-2">
      <PrintableTextarea 
        className="text-sm "
  ...
  <div>
    <div className="text-xs-1 font-bold text-gray-500 mb-1">Known Drug Allergy:</div>
    <div className="bg-yellow-100 border border-yellow-700 rounded p-2">
      <PrintableTextarea 
  ...
  <div className="grid grid-cols-2 gap-4">
    {/* Doctor's Note */}
    <div>
      <div className="text-xs-1 font-bold text-gray-500 mb-1">Doctor's Note:</div>
      <div className="bg-sky-100 border border-sky-700 rounded p-2">
        <PrintableTextarea 
          className="text-sm "
    ...
    {/* Investigations */}
    <div>
      <div className="text-xs-1 font-bold text-gray-500 mb-1">Investigations Advised:</div>
      <div className="bg-sky-100 border border-sky-700 rounded p-2">
        <PrintableTextarea 
          className="text-sm "
  ...
  {/* Medications Table */}
  <div className="bg-red-500 flex justify-between items-end mb-2 pointer-events-auto">
    <h5 className="text-gray-900 font-bold text-base ml-4">R  Medications:</h5>
    <Button 
      variant="ghost" 
      size="sm" 
...
{/* </div> */}
  ...
  {/* Footer */}
  {/* <div className="w-full border-b-4  border-gray-900 mb-0"></div> */}
  {/* Dotted red line at the very start - darker red */}

 <div className="mt-auto pt-8 flex flex-col items-end pointer-events-auto bg-sky-300">
  
  {/* Existing solid black line */}
  <div className="w-48 border-b border-gray-800 mb-2 mr-[270px]"></div>
  
  <p className="text-sm font-bold text-black mr-[309]">{doctor.name} (Signature)</p>
