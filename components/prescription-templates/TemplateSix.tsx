...
const TemplateFive: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
  ...
  {/* Header */}
<header className="bg-gray-900 border-b-4 border-teal-600 pb-4 mb-4 pointer-events-auto text-white pl-6 md:pl-8 lg:pl-10"
  ...
  <div className="flex items-center gap-4">
   ...
   <div className="w-16 h-16 flex items-center justify-center text-white font-bold text-xl overflow-hidden" 
    ...
    <div>
      ...
      <p className="text-xs mb-1 opacity-90">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
      <p className="text-xs mb-0 opacity-90">{doctor.address}</p>
      <h1 className="text-2xl font-bold uppercase tracking-wider">{doctor.clinicName}</h1>
      <p className="text-xs opacity-90"><strong>Email:</strong> {doctor.email} | <strong>Phone:</strong> {doctor.phone}</p>
    </div>
  </div>
</header>
  ...
  {/* Case Details Section */}
   <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Chief Complaints */}
                  <div className="bg-gray-50 border-2 border-dashed border-gray-400 p-2 rounded-r">
                  ...
                  {/* Diagnosis */}
                  <div className="bg-gray-50 border-2 border-dashed border-red-500 p-2 rounded-r">
                      <div className="text-xs font-bold text-red-700 uppercase mb-1">Diagnosis</div>
                      <PrintableTextarea 
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Past History */}
                  <div className="border-2 border-dashed border-gray-500 rounded p-2">
                      <div className="text-xs font-bold text-gray-900 mb-1">Past History:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Allergies */}
                  <div className="border-2 border-dashed border-gray-500 rounded p-2">
                      <div className="text-xs font-bold text-gray-900 mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm "
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Doctor's Note */}
                  <div className="border-2 border-dashed border-gray-500 rounded p-2">
                      <div className="text-xs font-bold text-gray-900 mb-1">Doctor's Note:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Investigations */}
                  <div className="border-2 border-dashed border-gray-500 rounded p-2">
                      <div className="text-xs font-bold text-gray-900 mb-1">Investigations Advised:</div>
                      <PrintableTextarea 
                          className="text-sm "
  ...
  {/* Footer */}
  <div className="w-full border-b border-dashed border-red-400 mb-0">

  </div>
  {/* Dotted red line at the very start - darker red */}

 <div className="mt-auto pt-8 flex flex-col items-end pointer-events-auto bg-gray-900">
  
  {/* Existing solid black line */}
  <div className="w-48 border-b border-gray-800 mb-2"></div>
  
  <p className="text-sm font-bold pr-4 text-gray-50">{doctor.name} (Signature)</p>
