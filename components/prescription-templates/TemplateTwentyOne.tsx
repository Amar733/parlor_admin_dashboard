...
>
 ...
 <div class="absolute top-0 left-0 h-full w-[95px] flex flex-col items-center justify-center pointer-events-none z-10 py-8">
    <div class="transform -rotate-90 origin-center text-gray-100 font-bold tracking-wider whitespace-nowrap text-xl md:text-2xl lg:text-3xl bg-green-800/30 px-0 py-0 rounded-lg">
      PRESCRIPTION
    </div>
  </div>
  {/* Header */}
...
<span className="my-5">||</span>
    ...
    {/* Age/sex */}
     <div className="flex items-center gap-0 mx-8">
      ...
      <div className="flex gap-1 items-center">
        ...
        <PrintableInput 
          className="w-20 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-0 text-center"
          value={patient.sex}
  ...
  {/* Case Details Section */}
          <div className=" grid grid-cols-2  gap-4 mb-4 pointer-events-auto">
                  {/* Chief Complaints */}
                  <div className="bg-green-100 border-l-4 border-gray-400 p-2 rounded-r">
                  ...
                  {/* Diagnosis */}
                  <div className="bg-green-100 border-l-4 border-green-500 p-2 rounded-r">
                      <div className="text-xs-1 font-bold text-gray-900 uppercase mb-1">Diagnosis</div>
                      <PrintableTextarea 
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Past History */}
                  <div className="bg-green-100 border border-gray-200 rounded p-2">
