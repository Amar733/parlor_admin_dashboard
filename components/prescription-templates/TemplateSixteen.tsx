...
const TemplateSixteen: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-orange-400 border-b-0 border-sky-400 border-teal-600 pb-8 mb-0 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 "
...
>
  ...
  <div className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm">
    <div className="flex flex-col gap-2 -my-3">
      <strong className="text-orange-400  mt-2">Sr. No.:</strong>
...
<div className="flex flex-col gap-2">
  ...
  <div className="relative flex items-center">
    ...
    <div className="flex flex-col gap-2">
      <strong className="text-orange-400">Dr. Name:</strong>
      <span className="">{doctor.name}</span>
    </div>

    <div className="flex flex-col gap-2 col-span-1 my-2">
      <strong className="text-orange-400">Patient Name:</strong>
      <PrintableInput 
  ...
  <strong className="text-orange-400 whitespace-nowrap pt-1">Age/Sex:</strong>
  <div className="flex flex-col">
    ...
    <div className="flex flex-col gap-2 my-2">
      <strong className="text-orange-400">Dr. Room No.:</strong>
      <PrintableInput 
    ...
    <div className="flex flex-col gap-2 col-span-1">
      <strong className="text-orange-400">Contact No.:</strong>
      <PrintableInput 
        className="flex-1 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 "
  ...
  {/* Case Details Section */}
   <div className=" grid grid-cols-2 gap-4 mb-4 my-5 pointer-events-auto">
                  ...
                  <div className="bg-gray-50 border-l-4 border-gray-400 p-2 rounded-r">
                      <div className="text-xs font-bold text-yellow-500 uppercase mb-1">Chief Complaints</div>
                      <PrintableTextarea 
                          className="text-sm "
                          minHeight="3rem"
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  ...
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-800 mb-1">Past History:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Allergies */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-800 mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm "
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Doctor's Note */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-800 mb-1">Doctor's Note:</div>
                      <PrintableTextarea 
                          className="text-sm "
...
{/* </div> */}
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-orange-100">
