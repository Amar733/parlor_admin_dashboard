...
const TemplateFourteen: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-red-700 border-b-4 border-teal-600 pb-8 mb-7 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 " 
...
>
  ...
  {/* Patient Info Grid */}
  <section className="relative p-9 -my-8 mb-4 border border-black border-l-0 border-r-0 border-b-dashed rounded-sm pointer-events-auto bg-red-100">
  <div className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm">
    <div className="flex flex-col gap-2 -my-3">
      <strong className="text-red-700  mt-2">Sr. No.:</strong>
...
<div className="flex flex-col gap-2">
  ...
  <div className="relative flex items-center">
    <PrintableInput 
      type="date"
      className="bg-transparent border-none outline-none  p-0 h-5 l-1 pr-6 hover:bg-gray-400 " // Added right padding
      value={patient.date}
    ...
    <div className="flex flex-col gap-2">
      <strong className="text-red-700">Dr. Name:</strong>
      <span className="">{doctor.name}</span>
    </div>

    <div className="flex flex-col gap-2 col-span-1 my-2">
      <strong className="text-red-700">Patient Name:</strong>
      <PrintableInput 
  ...
  <strong className="text-red-700 whitespace-nowrap pt-1">Age/Sex:</strong>
  <div className="flex flex-col">
    ...
    <div className="flex flex-col gap-2 my-2">
      <strong className="text-red-700 ">Dr. Room No.:</strong>
      <PrintableInput 
    ...
    <div className="flex flex-col gap-2 col-span-1">
      <strong className="text-red-700">Contact No.:</strong>
      <PrintableInput 
        className="flex-1 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 "
  ...
  <div className="w-full border-b -my-4 border-b-4 border-red-800 mb-0"></div>
  ...
  <div className="w-full border-b border-b-4 border-red-800 mb-0"></div>
...
{/* </div> */}
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-red-100">
