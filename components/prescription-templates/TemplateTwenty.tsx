...
const TemplateTwenty: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
  ...
  {/* Header */}
  <header className="bg-gray-700 border-t border-b-4 border-black border-teal-600 py-8 px-6 mb-4 pointer-events-auto text-white md:px-10 lg:px-16" 
