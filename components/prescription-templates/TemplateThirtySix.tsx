...
const TemplateThirtySix: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
   ...
   {/* Header */}
  <header className="flex justify-between items-start  bg-orange-400 text-gray-100 text-start pt-8 pb-4 px-10 relative"
...
{/* Patient Info Grid - Matching PDF table-like layout */}
     <section className="grid grid-cols-1 bg-gray-50 gap-y-1 gap-x-3 text-sm-1  -my-3 border-b-2 border-orange-500 pb-4 mb-8 py-8  pointer-events-auto">
     {/* First Row */}
