...
>
  ...
  {/* Header */}
<header className="bg-red-300 border-b-4 border-teal-600 pb-4 mb-4 pointer-events-auto text-white pl-6 md:pl-8 lg:pl-10"
  ...
  <div className="border-2 border-dashed border-red-500 p-2 rounded-lg">
 ...
 <div className="mt-auto pt-8 flex flex-col items-end pointer-events-auto bg-red-100">
