...
const TemplateThirty: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
   ...
   {/* Header */}
<header 
  className="relative pt-8 pb-12 px-8 md:px-12 lg:px-16 text-white"
  style={{
    background: '#6a0dad',
    clipPath: 'polygon(0 0, 100% 0, 100% 80%, 0 100%)',
     borderBottom: `4px solid transparent`, borderImage: `${headerColor} 1`
    }}
>
  <div className="relative z-10 flex justify-between items-start">
    <div>
      <div className="flex items-center gap-2 mb-2">
        <h4 className="text-xl font-black text-white uppercase mb-0"
       style={headerColor.includes('gradient') ? { backgroundImage: headerColor, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' } : { color: headerColor }}
        >
          DR. {doctor.name?.toUpperCase()}, {doctor.degree}
        </h4>
      </div>
      <p 
        ...
        style={{ color: '#e0b0ff' }}
      >
        {doctor.speciality} | Reg No: <strong className="text-white">{doctor.regNo}</strong>
      </p>
      <p 
        className="text-sm mb-0"
        style={{ color: '#e0b0ff' }}
      >
        {doctor.address} | Phone: {doctor.phone}
      </p>
    </div>

    {/* Logo - Matching PDF circular design with orange */}
  ...
  {/* Print styles using inline style with @media */}
  <style>{`
    @media print {
      header {
      ...
      header > div > div:last-child {
        ...
        color: #000 !important;
        box-shadow: 0 0 0 3px #fff, 0 0 0 1px #000 !important;
      }
      header p {
        color: #666 !important;
      }
...
<section className="grid grid-cols-3 bg-orange-50 gap-y-1 gap-x-3 text-sm-1 -my-3 border-b-4 border-orange-500 pb-4 mb-8 py-8 pointer-events-auto">
    {/* Sr. No./Date combined - stacked */}
    <div className="flex flex-col ml-4">
      <strong className="text-[#6a0dad]">Sr. No./Date:</strong>
    ...
    <div className="flex flex-col ml-14">
      <strong className="text-[#6a0dad]">Patient Name:</strong>
      <div className="flex items-center gap-0.5 mt-1">
        <PrintableInput 
  ...
  <div className="grid grid-rows-2 items-start gap-4">
    <strong className="text-[#6a0dad] text-right mr-16">Dr.Name/Room:</strong>
  ...
  <div className="flex flex-col ml-4">
   ...
   <div className="flex flex-col">
    {/* Labels on same line */}
    <div className="flex">
      <strong className="text-[#6a0dad]">Contact No.:</strong>
      <div className="mx-2">|</div>
      <strong className="text-[#6a0dad]">Address</strong>
    </div>
  ...
  {/* Case Details Section */}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="bg-purple-50 border border-[#6a0dad] p-2 rounded-r">
            <PrintableTextarea 
              className="text-sm "
              minHeight="3rem"
      ...
      <div>
        ...
        <div className="bg-purple-50 border border-[#6a0dad] rounded p-2">
          <PrintableTextarea 
            className="text-sm "
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-orange-400">
