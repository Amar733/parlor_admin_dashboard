...
const TemplateTwentyOne: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
  ...
  <div class="border-l-[55px] border-l-green-900 pl-4">

 <div class="absolute top-0 left-0 h-full w-[95px] flex flex-col items-center justify-center pointer-events-none z-10 py-8">
    <div class="transform -rotate-90 origin-center  font-bold tracking-wider whitespace-nowrap text-xl md:text-2xl lg:text-3xl  px-0 py-0 rounded-lg"
...
<header className="bg-gray-100 border-b-4  border-green-900 border-teal-600 pb-8 mb-7 pointer-events-auto text-black pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16"
...
>
  ...
  {/* Patient Info Grid */}
  <section className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm border-b border-green-700 pb-4 mb-4 pointer-events-auto bg-gray-99">
    <div className="grid grid-cols-3">
    <div className="flex items-center gap-2 my-3">
      <strong className="text-green-700">Sr. No.:</strong>
      <span className="p-1">{prescriptions && prescriptions.length > 0 ? prescriptions.length + 1 : "1"}</span>
    </div>
<span className="my-5">||</span>
    <div className="flex items-center gap-0 -mx-6 print:-mx-6">
      <strong className="text-green-700 -mx-9 print:-mx-9">Date:</strong>
      <PrintableInput 
        type="date"
        className="bg-transparent border-none outline-none  p-0 h-auto mx-9 print:mx-[9px] print:w-full print:ml-[50px] hover:bg-gray-400"
        value={patient.date}
    ...
    {/* Age/sex */}
     <div className="flex items-center gap-0 mx-8">
      <strong className="text-green-700">Age/Sex:</strong>
      <div className="flex gap-0 items-center">
        <PrintableInput 
          ...
          readOnly={isPreviewMode}
        />
        <span className="-mx-0 -ml-2">|</span>
        <PrintableInput 
          className="w-[100px] bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-0 text-center"
          value={patient.sex}
    ...
    <div className="flex items-center gap-2">
      <strong className="text-green-700">Dr. Room No.:</strong>
      <PrintableInput 
    ...
    <div className="flex items-center gap-2 col-span-1">
      <strong className="text-green-700">Patient Name:</strong>
      <PrintableInput 
    ...
    <div className="flex items-center gap-2 col-span-1">
      <strong className="text-green-700">Contact No.:</strong>
      <PrintableInput 
        className="flex-1 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 "
  ...
  {/* Case Details Section */}
          <div className=" grid grid-cols-2  gap-4 mb-4 pointer-events-auto">
                  {/* Chief Complaints */}
                  <div className="bg-gray-5 border-2 border-yellow-400 p-2 rounded-r">
                      <div className="text-xs-1 font-bold text-yellow-400 uppercase mb-1">Chief Complaints</div>
                      <PrintableTextarea 
                          className="text-sm "
                          minHeight="3rem"
                  ...
                  {/* Diagnosis */}
                  <div className="bg-gray-5 border-2 border-green-500 p-2 rounded-r">
                      <div className="text-xs-1 font-bold text-green-900 uppercase mb-1">Diagnosis</div>
                      <PrintableTextarea 
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Past History */}
                  <div className="bg-gray-5 border-2 border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-900 mb-1">Past History:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Allergies */}
                  <div className="bg-gray-5 border-2 border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-900 mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm "
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Doctor's Note */}
                  <div className="bg-gray-5 border-2 border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-900 mb-1">Doctor's Note:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Investigations */}
                  <div className="bg-gray-5 border-2 border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-gray-900 mb-1">Investigations Advised:</div>
                      <PrintableTextarea 
                          className="text-sm "
  ...
  {/* Medications Table */}
  <div className="bg-green-800 flex justify-between items-end mb-2 pointer-events-auto -mx-4">
    <h5 className="text-gray-100 font-bold text-base ml-4">R  Medications:</h5>
    <Button 
      variant="ghost" 
      size="sm" 
    //   className={`h-6 text-xs-1 text-gray-100 text-teal-600 hover:text-teal-100 print:hidden ${isPreviewMode ? 'opacity-0 pointer-events-none' : ''}`}
      className={`h-6 text-xs-1 text-white hover:text-teal-700 print:hidden ${isPreviewMode ? 'opacity-0 pointer-events-none' : ''}`}
      onClick={addRow}
    >
      + Add Row
    </Button>
...
<div className="w-290 -mr-4   border-b-4 border-green-700 mb-0"></div>
  {/* Existing solid black line */}
 <div className="mt-auto -mr-4 ml-0.5 -mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-gray-100">
