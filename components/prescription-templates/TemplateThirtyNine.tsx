...
const TemplateThirtyNine: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
   ...
   {/* Header */}
  <header className="flex justify-between items-start border-2  bg-purple-700 text-gray-100 text-start pt-8 pb-4 px-10 relative"
...
>
  ...
  <div className="flex-1">
    ...
    <p className="text-sm-1 text-white mb-1">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
    <p className="text-sm-1 text-white mb-0">{doctor.address} | Phone: {doctor.phone}</p>
  </div>
