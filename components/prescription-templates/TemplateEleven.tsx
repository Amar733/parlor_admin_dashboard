...
const TemplateEight: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
  ...
  {/* Header */}
  <div className="w-full border-b-8 border-yellow-400 mb-0"
             style={{ borderBottom: `4px solid transparent`, borderImage: `${headerColor} 1` }}
  >
  </div>
<header className="bg-gray-600 border-b-4 border-teal-600 pb-8 mb-7 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 " >
  <div className="flex items-center gap-4 ">
    ...
    <div>
      ...
      <p className="text-xs mb-1 opacity-90 p-1">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
      <p className="text-xs mb-0 opacity-90 p-0.5">{doctor.address}</p>
      <h1 className="text-2xl font-bold uppercase tracking-wider">{doctor.clinicName}</h1>
      <p className="text-xs opacity-90 p-1"><strong>Email:</strong> {doctor.email} | <strong>Phone:</strong> {doctor.phone}</p>
    </div>
  </div>
</header>
  ...
  {/* Patient Info Grid */}
  <section className="relative p-9 -my-4 mb-4 border border-black border-l-4 border-l-yellow-500 rounded-sm pointer-events-auto bg-gray-99">
  <div className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm">
    ...
    <div className="flex items-center gap-2 col-span-1 my-2">
   ...
   <div className=" grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  ...
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold  mb-1">Past History:</div>
                      <PrintableTextarea 
                  ...
                  {/* Allergies */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold  mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm text-gray-900"
...
{/* </div> */}
 ...
 <div className="mt-auto -mr-8 -ml-8 -mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-gray-100">
