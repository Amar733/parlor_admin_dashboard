...
const TemplateTwentyNine: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-white   pb-6 mb-8 pt-8 px-8 md:px-12 lg:px-16"
             style={{ borderBottom: `4px solid ${headerColor}`, borderImage: `${headerColor} 1` }}
>
  <div className="flex justify-between items-start">
    <div>
      <div className="flex items-center gap-2 mb-2">
        <h4 className="text-xl font-black text-gray-900 uppercase mb-0"
       style={headerColor.includes('gradient') ? { backgroundImage: headerColor, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' } : { color: headerColor }}
        >DR. {doctor.name?.toUpperCase()}, {doctor.degree}</h4>
      </div>
      <p className="text-sm text-gray-600 mb-1">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
      <p className="text-sm text-gray-600 mb-0">{doctor.address} | Phone: {doctor.phone}</p>
    </div>

    {/* Logo - Matching PDF circular design */}
...
<section className="border border-gray-300 mx-8 md:mx-12 lg:mx-16 my-6 pointer-events-auto">
  ...
  <div className="grid grid-cols-2 border-b border-gray-300">
    ...
    <div className="grid grid-cols-2 px-4 py-2">
      ...
      <PrintableInput 
        type="date"
        className="bg-transparent border-none outline-none  p-0 h-auto w-full max-w-[200px] inline-block  -ml-[90px] hover:bg-gray-400"
        value={patient.date}
  ...
  <div className="grid grid-cols-2 border-b border-gray-300">
    <div className="grid grid-cols-2 px-4 py-2 border-r border-gray-300">
      ...
      <PrintableInput 
        className="bg-transparent border-b border-transparent hover:border-gray-300 focus:border-gray-400 outline-none  inline-block min-w-[150px] px-1 mt-2 -ml-2"
        value={patient.name}
    ...
    <div className="grid grid-cols-2 px-4 py-2">
      ...
      <div className="inline-flex gap-2">
        <PrintableInput 
          className="bg-transparent border-b border-transparent hover:border-gray-300 focus:border-gray-400 outline-none  w-12 px-1 -ml-[50px]"
          value={patient.age}
        ...
        <PrintableInput 
          className="bg-transparent border-b border-transparent hover:border-gray-300 focus:border-gray-400 outline-none  w-16 px-1"
          value={patient.sex}
  ...
  <div className="grid grid-cols-2 px-4 py-2">
    ...
    <div className="grid grid-cols-3 inline-flex gap-2 flex-wrap">
      <PrintableInput 
        className="bg-transparent border-b border-transparent hover:border-gray-300 focus:border-gray-400 outline-none  min-w-[200px] px-1 -ml-[159px] mb-1"
      ...
      <PrintableInput 
        className="bg-transparent border-b border-transparent hover:border-gray-300 focus:border-gray-400 outline-none  min-w-[120px] px-1 -ml-[140px] mb-1"
  ...
  {/* Case Details Section */}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <div className="text-xs-1 border-b-2 font-bold text-gray-900 uppercase mb-4">Chief Complaints</div>
          <div className="bg-yellow-50 border-l-4 border-red-700 p-2 rounded-r">
            <PrintableTextarea 
              className="text-sm "
              minHeight="3rem"
      ...
      <div>
        <div className="text-xs-1 border-b-2  font-bold text-gray-900 mb-4">Past History:</div>
        <div className="bg-yellow-50 border-l-4 border-red-700 rounded p-2">
          <PrintableTextarea 
            className="text-sm "
      ...
      <div>
        <div className="text-xs-1 font-bold text-gray-900 border-b-2 mb-4">Known Drug Allergy:</div>
        <div className="bg-red-100 border-l-4 border-red-700 rounded p-2">
          <PrintableTextarea 
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Doctor's Note */}
        <div>
          <div className="text-xs-1 font-bold text-gray-900 border-b-2 mb-4">Doctor's Note:</div>
          <div className="bg-yellow-50 border-l-4 border-red-700 rounded p-2">
            <PrintableTextarea 
              className="text-sm "
        ...
        {/* Investigations */}
        <div>
          <div className="text-xs-1 font-bold text-gray-900 border-b-2 mb-4">Investigations Advised:</div>
          <div className="bg-yellow-50 border-l-4 border-red-700 rounded p-2">
            <PrintableTextarea 
              className="text-sm "
...
<div className="pointer-events-auto">
    <p className="font-bold text-gray-900 text-sm border-b-4 border-gray-100 mt-4">Advice / Follow-up</p>
    <PrintableTextarea 
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-gray-50">
