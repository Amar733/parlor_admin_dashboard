...
const TemplateTwentyEight: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-gray-600 border-b-0    border-teal-600 pb-4 mb-8 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 "
...
>
  <div className="flex items-center gap-4 ">
    ...
    <div>
      <h4 className="text-xl font-bold mb-0 uppercase text-gray-100 p-1"
      ...
      <p className="text-xs-1 mb-1 text-gray-50 opacity-90 p-1">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
      <p className="text-xs-1 mb-0 text-gray-40 opacity-90 p-0.5">{doctor.address}</p>
      <h1 className="text-2xl text-gray-50 font-bold uppercase tracking-wider">{doctor.clinicName}</h1>
      <p className="text-xs-1 text-gray-50 opacity-90 p-1"><strong>Email:</strong> {doctor.email} | <strong>Phone:</strong> {doctor.phone}</p>
    </div>
  ...
  {/* Patient Info Grid */}
  <section className="grid grid-cols-3 bg-gray-50 border-b-4 border-b-gray-800 gap-y-1 gap-x-3 text-sm-1 -my-3  pb-4 mb-8 py-8 pointer-events-auto">
  ...
  {/* Case Details Section */}
   <div className=" grid grid-cols-2 gap-4 mb-4 my-5 pointer-events-auto">
                    ...
                    {/* Diagnosis */}
                    <div className="bg-gray-50 border border-green-500 p-2 rounded-r">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                    {/* Past History */}
                    <div className="bg-gray-50 border border-gray-400 rounded p-2">
                    ...
                    {/* Allergies */}
                    <div className="border border-red-400 rounded p-2">
                        <div className="text-xs-1 font-bold text-red-700 mb-1">Known Drug Allergy:</div>
                        <PrintableTextarea 
...
{/* Advice & Follow Up */}
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-gray-100 border-t-4 border-gray-900">
  {/* Existing solid black line */}
  <div className="w-48 border-b border-gray-800 mb-2"></div>
  
  <p className="text-sm-1 mr-4 font-bold text-gray-900">{doctor.name} (Signature)</p>
