...
const TemplateEighteen: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-gray-50 border-b-4 border-t border-sky-900 border-teal-600 pb-8 mb-0 pointer-events-auto text-black pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 " 
...
>
  <div className="flex items-center gap-4 ">
   ...
   <div className="w-16 h-16 flex items-center justify-center text-white font-bold text-xl overflow-hidden" 
    ...
    <div>
      ...
      <p className="text-xs-1 mb-1 opacity-90 p-1 font-bold ">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
  ...
  {/* Patient Info Grid */}
  <section className="relative p-9 -my-8  mb-4 my-1 border border-black-0 border-l-0 border-r-0 border-u-0  border-b-dashed rounded-sm pointer-events-auto bg-gray-50">
  
  <div className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm">
    <div className="flex flex-col gap-2 -my-3">
      <strong className="text-purple-900  mt-2">Sr. No.:</strong>
      <span className="">{prescriptions && prescriptions.length > 0 ? prescriptions.length + 1 : "1"}</span>
    </div>

<div className="flex flex-col gap-2">
  <div className="flex items-center gap-2">
    <strong className="text-purple-900">Date:</strong>
  </div>
  <div className="relative flex items-center">
    <PrintableInput 
      type="date"
      className="bg-transparent border-none outline-none  p-0 h-4 l-1 pr-6 hover:bg-gray-400" // Added right padding
      value={patient.date}
    ...
    <div className="flex flex-col gap-2">
      <strong className="text-purple-900">Dr. Name:</strong>
      <span className="">{doctor.name}</span>
    </div>

    <div className="flex flex-col gap-2 col-span-1 my-2">
      <strong className="text-purple-900">Patient Name:</strong>
      <PrintableInput 
  ...
  <div className="flex flex-col gap-2 mx-1 mr-6  my-2">
  <strong className="text-purple-900 whitespace-nowrap pt-1">Age/Sex:</strong>
  <div className="flex flex-col">
    <div className="flex gap-1 items-center">
      <PrintableInput 
        className="w-12 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 text-start -mr-5"
        value={patient.age}
      ...
      <PrintableInput 
        className="w-20 bg-transparent border-b border-gray-300 focus:border-teal-600 outline-none px-0 text-start -ml-16 mr-6"
        value={patient.sex}
    ...
    <div className="flex flex-col gap-2 my-2">
      <strong className="text-purple-900">Dr. Room No.:</strong>
      <PrintableInput 
        className="w-16 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-0 -ml-16 text-center"
    ...
    <div className="flex flex-col gap-2 col-span-1">
      <strong className="text-purple-900">Contact No.:</strong>
      <PrintableInput 
        className="flex-1 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 "
  ...
  {/* Case Details Section */}
   <div className=" grid grid-cols-2 gap-4 mb-4 my-5 pointer-events-auto">
                  ...
                  <div className="bg-gray-50 border-l-4 border-gray-400 p-2 rounded-r">
                      <div className="text-xs font-bold text-sky-500 uppercase mb-1">Chief Complaints</div>
                      <PrintableTextarea 
                          className="text-sm "
                          minHeight="3rem"
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  ...
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-purple-900 mb-1">Past History:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Allergies */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-purple-900 mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm "
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Doctor's Note */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-purple-900 mb-1">Doctor's Note:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Investigations */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-purple-900 mb-1">Investigations Advised:</div>
                      <PrintableTextarea 
                          className="text-sm "
  ...
  <div className="flex justify-between items-end mb-2 pointer-events-auto">
    <h5 className="text-red-900 font-bold text-base">R  Medications:</h5>
    <Button 
      variant="ghost" 
      size="sm" 
  ...
  <div className="w-full border-b border-b border-gray-900 mb-0"></div>
...
{/* </div> */}
  ...
  {/* Advice & Follow Up */}
  {/* <div className="w-full border-b border-b-4 border-orange-400 mb-0"></div> */}
  ...
  {/* Footer */}
  <div className="w-full border-b border-b border-gray-400 mb-0"></div>

 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto 
  bg-gradient-to-tl from-purple-200 from-50% via-gray-100 via-50% to-transparent to-50%"
  >
  {/* Existing solid black line */}
  <div className="w-48 border-b border-gray-100 mb-2  "></div>
  
  <p className="text-sm-1 mr-4 font-bold text-black">{doctor.name} (Signature)</p>
