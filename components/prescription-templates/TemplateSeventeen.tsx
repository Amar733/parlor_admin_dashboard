...
const TemplateSeventeen: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-purple-900 border-b-4 border-purple-400 border-teal-600 pb-8 mb-0 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 " 
  ...
  <div className="flex items-center gap-4 ">
   ...
   <div className="w-16 h-16 flex items-center justify-center text-white font-bold text-xl overflow-hidden" 
    ...
    <div>
      ...
      <p className="text-xs-1 mb-1 opacity-90 p-1 font-bold text-gray-100">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
...
{/* </div> */}
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-gray-100">
