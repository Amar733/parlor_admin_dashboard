...
const TemplateThirtyEight: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
   ...
   {/* Header */}
  <header className="flex justify-between items-start border-2  bg-yellow-50 text-gray-100 text-start pt-8 pb-4 px-10 relative"
