...
const TemplateFourty: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
>
   ...
   {/* Header */}
  <header className="flex justify-between items-start border-0  bg-gray-100 text-gray-100 text-start pt-8 pb-4 px-10 relative"
...
>
  ...
  <div className="flex-1">
    ...
    <p className="text-sm-1 text-gray-900 mb-1">{doctor.speciality} | Reg No: <strong>{doctor.regNo}</strong></p>
    <p className="text-sm-1 text-gray-900 mb-0">{doctor.address} | Phone: {doctor.phone}</p>
  </div>
