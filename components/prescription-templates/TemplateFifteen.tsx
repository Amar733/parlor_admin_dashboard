...
const TemplateFifteen: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-gray-900 border-b-4 border-sky-400 border-teal-600 pb-8 mb-0 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 "
...
>
  ...
  {/* Patient Info Grid */}
  <section className="relative p-9 -my-8  mb-4 my-px border border-black border-l-0 border-r-0 border-u-0  border-b-dashed rounded-sm pointer-events-auto bg-sky-50">
  
  <div className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm">
    <div className="flex flex-col gap-2 -my-3">
      <strong className="text-sky-600  mt-2">Sr. No.:</strong>
      <span className="">{prescriptions && prescriptions.length > 0 ? prescriptions.length + 1 : "1"}</span>
    </div>

<div className="flex flex-col gap-2">
  <div className="flex items-center gap-2">
    <strong className="text-sky-600">Date:</strong>
  </div>
  <div className="relative flex items-center">
    ...
    <div className="flex flex-col gap-2 col-span-1 my-2">
      <strong className="text-sky-600">Patient Name:</strong>
      <PrintableInput 
  ...
  <strong className="text-sky-600 whitespace-nowrap pt-1">Age/Sex:</strong>
  <div className="flex flex-col">
    ...
    <div className="flex flex-col gap-2 my-2">
      <strong className="text-sky-600">Dr. Room No.:</strong>
      <PrintableInput 
    ...
    <div className="flex flex-col gap-2 col-span-1">
      <strong className="text-sky-600">Contact No.:</strong>
      <PrintableInput 
        className="flex-1 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 "
    ...
    <div className="flex flex-col gap-2 col-span-2">
      <strong className="text-sky-600">Address:</strong>
      <PrintableInput 
        className="flex-1 bg-transparent border-b border-gray-300 focus:border-teal-500 outline-none px-1 "
   ...
   <div className=" grid grid-cols-2 gap-4 mb-4 my-5 pointer-events-auto">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  ...
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-800 mb-1">Past History:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Allergies */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-800 mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm "
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Doctor's Note */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-800 mb-1">Doctor's Note:</div>
                      <PrintableTextarea 
                          className="text-sm "
                  ...
                  {/* Investigations */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-800 mb-1">Investigations Advised:</div>
                      <PrintableTextarea 
                          className="text-sm "
...
{/* </div> */}
 ...
 <div className="mt-auto mr-0.5 ml-0.5 mb-8 pt-8 flex flex-col items-end pointer-events-auto bg-gray-900">
