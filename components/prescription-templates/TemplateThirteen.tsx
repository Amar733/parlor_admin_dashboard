...
const TemplateThirteen: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<header className="bg-green-700 border-b-4 border-teal-600 pb-8 mb-7 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16 " 
...
>
  ...
  {/* Patient Info Grid */}
  <section className="relative p-9 -my-4 mb-4 border border-black border-l-1 border-b-dashed rounded-sm pointer-events-auto bg-gray-99">
