...
const TemplateThirtyThree: React.FC<PrescriptionTemplateProps> = ({
  doctor,
  patient,
  notes,
  rows,
...
<section className="grid grid-cols-1 bg-sky-50 gap-y-1 gap-x-3 text-sm-1 -my-3 border-b-0 border-orange-500 pb-4 mb-8 py-8  pointer-events-auto">
     {/* First Row */}
  ...
  {/* Case Details Section */}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <div className="text-xs-1 border-b-0 font-bold text-gray-900 uppercase mb-4">Chief Complaints</div>
          <div className="bg-purple-50 border border-sky-400 p-2 rounded-r">
            <PrintableTextarea 
        ...
        {/* Diagnosis Section */}
        <div>
          <div className="text-xs border-b-0 font-bold text-green-700 uppercase mb-2">Diagnosis</div>
      ...
      <div>
        <div className="text-xs-1 font-bold text-gray-900 border-b-0 mb-4">Known Drug Allergy:</div>
