...
>
  ...
  {/* Header */}
<header className="bg-sky-500 border-b-4 border-teal-600 pb-8 mb-8 pointer-events-auto text-white pl-8 md:pl-12 lg:pl-16 pt-8 pr-8 md:pr-12 lg:pr-16"
...
>
  ...
  {/* Patient Info Grid */}
  <section className="grid grid-cols-3 gap-y-2 gap-x-4 text-sm border-b border-gray-200 pb-4 mb-4 pointer-events-auto bg-sky-50">
    ...
    <div className="flex items-center gap-2">
      ...
      <PrintableInput 
        type="date"
        className="bg-transparent border-none outline-none  p-2 h-auto hover:bg-gray-400"
        value={patient.date}
   ...
   <div className=" grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  ...
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-500 mb-1">Past History:</div>
                      <PrintableTextarea 
                          className="text-sm-1 "
                  ...
                  {/* Allergies */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-500 mb-1">Known Drug Allergy:</div>
                      <PrintableTextarea 
                          className="text-sm-1 "
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 pointer-events-auto">
                  {/* Doctor's Note */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-500 mb-1">Doctor's Note:</div>
                      <PrintableTextarea 
                          className="text-sm-1 "
                  ...
                  {/* Investigations */}
                  <div className="border border-gray-200 rounded p-2">
                      <div className="text-xs-1 font-bold text-sky-500 mb-1">Investigations Advised:</div>
                      <PrintableTextarea 
                          className="text-sm-1 "
  ...
  {/* Footer */}
  <div className="w-full border-b  border-sky-700 mb-0">

  </div>

 <div className="mt-auto pt-8 flex flex-col items-end pointer-events-auto bg-sky-100">
  {/* Dotted sky line at the very start - darker sky */}
